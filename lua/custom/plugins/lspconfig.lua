-- Main LSP configuration: Mason installs servers/tools, lspconfig wires them
-- into Neovim's built-in LSP client, and the LspAttach autocmd sets buffer-local
-- keymaps (grn/gra/grr/gri/grd/...). See `:help lsp`.
return {
