...
M.lines = {
  ...
  '   d Debug         x Trouble       u UI toggles    w —',
  '   q Diag→loclist  m Motions       k This sheet    ? All keymaps',
  '',
  ' FIND  <leader>f                  SEARCH  <leader>s',
  '   ff files                         sg grep (live)    sw word under cursor',
  '   fr recent                        sd diagnostics    sk keymaps',
  '   fb buffers                       sh help           sr resume',
  '   fn nvim config                   ss doc symbols    s/ lines in buffers',
  ...
  '   x pick-close · o others · h/l close left/right · s/e sort dir/ext',
  '',
